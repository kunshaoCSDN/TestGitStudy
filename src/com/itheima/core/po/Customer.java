...
public class Customer implements Serializable {
	...
	private String cust_source;    //客户的信息来源
	private String cust_industry;	//客户的所属行业
	...
	private Integer start;			//起始行    分页使用
	private Integer rows;			//所取行数    分页使用
	...
	public String toString() {
		return "Customer [cust_id=" + cust_id + ", cust_name=" + cust_name + ", cust_user_id=" + cust_user_id
				...
				+ cust_address + ", cust_createtime=" + cust_createtime + ", start=" + start + ", rows=" + rows + "]";
	}
}
